            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="sua-tt.php">Sửa thông tin cá nhân</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><strong>Sửa thông tin cá nhân</strong></h1>
                    ...
                    if (array_key_exists("btn_submit", $_REQUEST)) {
                        ...
                        if ($password == "" | $email == "" | $tel == "") {
                            echo '<script language="javascript">';
                            echo 'alert("Chưa điền đủ thông tin!")';
                            echo '</script>';
                        } else {
                            $username = $_SESSION['user']['username'];
                            update_account($username, $password, $email, $tel);
                            echo '<script language="javascript">';
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control form-text text-muted" name="password" value="<?= $password ?>">
                        </div>
                        ...
                        <a class="btn btn-secondary custom" href="../index.php">Quay lại</a>
                    </form>
