        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><strong>Trang cá nhân</strong></h1>
                    ...
                    if (array_key_exists("btn_submit", $_REQUEST)) {
                        ...
                        if ($tin_nhan != "") {
                            ...
                            $nguoi_gui = $_SESSION['user']['username'];
                            insert_tin_nhan($nguoi_gui,$username,$thoi_gian,$tin_nhan);
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tin_nhan" placeholder="Gửi tin nhắn cho người này ...">
                        </div>

                        <button type="submit" name="btn_submit" class="btn btn-primary custom">Gửi</button>
