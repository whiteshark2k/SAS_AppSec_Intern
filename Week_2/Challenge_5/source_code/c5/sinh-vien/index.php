                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Trang quản trị dành cho sinh viên</h6>
                        </div>
                        <div class="card-body">
                            <div class="text-center">
                                <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="../css/img/undraw_posting_photo.svg" alt="">
                            </div>
                            <p>Các chức năng của sinh viên bao gồm: <br>
                                <strong>1. Sinh viên:</strong> Sửa thông tin cá nhân, xem danh sách sinh viên, gửi tin nhắn, xem tin nhắn đến. <br>
                                <strong>2. Bài tập:</strong> Xem danh sách bài tập, nộp bài tập và xem lịch sử nộp bài <br>
                                <strong>3. Quiz:</strong> Xem danh sách quiz và trả lời quiz. <br>
                            </p>
                        </div>
                    </div>
