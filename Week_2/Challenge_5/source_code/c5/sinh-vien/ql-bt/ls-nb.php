            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="ls-nb.php">Lịch sử nộp bài</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><strong>Lịch sử nộp bài</strong></h1>

                    <!-- Lấy danh sách bài tập -->
                    <?php
                    require_once('../../dao/bai-tap.php');
                    $username = $_SESSION['user']['username'];
                    $item = select_bai_nop_by_username($username);
                    ?>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $thoi_gian_nop ?></td>
                                                <td>
                                                    <a href="attachments/<?= $bai_nop ?>"><?= $bai_nop ?></a>
                                                </td>
                                            </tr>
