        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><strong>Đáp án quiz</strong></h1>
                    <p class="mb-4">Chúc mừng bạn đã trả lời đúng</a></p>
                    ...
                    $trang_thai = select_tl_quiz($id_quiz, $username);
                    ...
                    if($trang_thai != TRUE){
                        ...
                        $dap_an_dung = $temp[0];
                        $filename = "../../giao-vien/quiz/attachments/" . $tep_dinh_kem;
                    ...
                    <form enctype="multipart/form-data">
                        <div class="form-group row">
                            <label for="" class="col-sm-2 col-form-label">Tên quiz</label>
                            <input type="text" class="form-control col-sm-10" value="<?= $ten_quiz ?>" readonly>
                        </div>

                        <div class="form-group row">
                            <label for="" class="col-sm-2 col-form-label">Gợi ý</label>
                            <input type="text" class="form-control col-sm-10" value="<?= $goi_y ?>" readonly>
                        </div>

                        <div class="form-group row">
                            <label for="" class="col-sm-2 col-form-label">Đáp án</label>
                            <input type="text" class="form-control col-sm-10" value="<?= $dap_an_dung ?>" readonly>
                        </div>

                        <div class="form-group">
                            <label for="">Nội dung</label>

                            <textarea rows="10" class="form-control" readonly><?= $contents ?></textarea>
                        </div>
