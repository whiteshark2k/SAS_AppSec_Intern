        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="../ql-sv/sua-tt.php">Sửa thông tin cá nhân</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="ds-quiz.php">Danh sách quiz</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><strong>Trả lời quiz</strong></h1>
                    <p class="mb-4">Nhập đáp án dưới dạng tiếng việt không dấu, viết hoa chữ cái đầu tiên, mỗi từ cách nhau bởi khoảng trống (ví dụ: Tuyen Ngon Doc Lap).</a></p>
                    ...
                    $item = select_quiz_by_id($id_quiz);
                    extract($item);
                    ...
                    if (array_key_exists("btn_submit", $_REQUEST)) {
                        ...
                        if ($dap_an == "") {
                            ...
                            echo 'alert("Chưa điền đáp án!")';
                            echo '</script>';
                        } else {
                            $temp = explode(".txt", $tep_dinh_kem);
                            $dap_an_dung = $temp[0];

                            if ($dap_an == $dap_an_dung) {
                                insert_tl_quiz($id_quiz,$username,1);
                                $url = "kq-quiz.php?id_quiz=" . $id_quiz;
                                echo '<script language="javascript">window.location.href ="' . $url . '"</script>';
                            } else {
                                echo '<script language="javascript">';
                                echo 'alert("Đáp án chưa chính xác!")';
                                echo '</script>';
                            }
                        }
                    }
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?= $ten_quiz ?>" readonly>
                        </div>

                        <div class="form-group">
                            <label for="">Gợi ý</label>
                            <input type="text" class="form-control" value="<?= $goi_y ?>" readonly>
                        </div>

                        <div class="form-group">
                            <label for="">Đáp án</label>
                            <input type="text" class="form-control" name="dap_an" placeholder="Nhập đáp án đúng định dạng ...">
                        </div>

                        <button type="submit" name="btn_submit" class="btn btn-primary custom">Submit</button>
