        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><strong>Danh sách quiz</strong></h1>

                    <!-- Lấy danh sách bài tập -->
                    <?php
                    require_once('../../dao/quiz.php');
                    $item = select_all_quiz();
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if ($trang_thai == "" || $trang_thai == FALSE) { ?>
                                                        <a href="tl-quiz.php?id_quiz=<?= $id_quiz ?>"><button class="btn btn-secondary custom">Trả lời</button></a>

                                                    <?php } else { ?>
                                                        <a href="kq-quiz.php?id_quiz=<?= $id_quiz ?>"><button class="btn btn-success custom">Xem đáp án</button></a>
                                                    <?php } ?>
                                                </td>
