        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><strong>Gửi tin nhắn cho sinh viên</strong></h1>
                    ...
                    if (array_key_exists("btn_update", $_REQUEST)) {
                        ...
                        if ($tin_nhan == "") {
                            ...
                            insert_tin_nhan($sender, $username, $thoi_gian, $tin_nhan);
                            echo '<script language="javascript">';
                            echo 'alert("Gửi tin nhắn thành công")';
                            echo '</script>';
                        }
                    }
                    ?>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="fullname" placeholder="Nhập họ và tên ..." value="<?= $fullname ?>" readonly>
                        </div>

                        <div class="form-group">
                            <label for="">Email người nhận</label>
                            <input type="text" class="form-control" name="email" placeholder="Nhập email ..." value="<?= $email ?>" readonly>
                        </div>

                        <div class="form-group">
                            <label for="">Tin nhắn</label>
                            <input type="text" class="form-control" name="tin_nhan" placeholder="Nhập tin nhắn ...">
                        </div>

                        <button type="submit" name="btn_update" class="btn btn-primary custom">Gửi</button>
