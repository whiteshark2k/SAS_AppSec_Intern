        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><strong>Danh sách sinh viên</strong></h1>

                    <!-- Lấy danh sách account -->
                    <?php
                    require_once('../../dao/account.php');
                    $item = select_all_account();
                    ?>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $tel ?></td>
                                                <td>
                                                    <a href="gui-tn.php?username=<?= $username ?>"><button class="btn btn-secondary custom2">Nhắn</button></a>
                                                    <a href="sua-sv.php?username=<?= $username ?>"><button class="btn btn-primary custom2">Sửa</button></a>
                                                    <a onclick="return confirm('Bạn có chắc chắn muốn xóa ?')" href="xoa-sv.php?username=<?= $username ?>"><button class="btn btn-danger custom2">Xóa</button></a>
                                                </td>
                                            </tr>
