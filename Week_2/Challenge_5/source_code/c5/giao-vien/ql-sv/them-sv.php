            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="them-sv.php">Thêm sinh viên</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><strong>Thêm sinh viên</strong></h1>
                    <p class="mb-4">Điền đầy đủ thông tin để tiến hành thêm sinh viên mới.</a>.</p>
                    ...
                    if (array_key_exists("btn_insert", $_REQUEST)) {
                        ...
                        if ($username == "" | $password == "" | $fullname == "" | $email == "" | $tel == "") {
                            echo '<script language="javascript">';
                            echo 'alert("Chưa nhập đủ thông tin!")';
                            echo '</script>';
                        } else {
                            insert_account(0, $username, $password, $fullname, $email, $tel);
                            echo '<script language="javascript">';
                            echo 'alert("Thêm sinh viên thành công")';
                            echo '</script>';
                            unset($username, $fullname, $password, $email, $tel);
                        }
                    }
                    ?>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control form-text text-muted" name="password" placeholder="Nhập mật khẩu ...">
                        </div>
