                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Trang quản trị dành cho giáo viên</h6>
                        </div>
                        <div class="card-body">
                            <div class="text-center">
                                <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="../css/img/undraw_posting_photo.svg" alt="">
                            </div>
                            <p>Các chức năng của giáo viên bao gồm: <br>
                                <strong>1. Quản lý sinh viên:</strong> Thêm, sửa, xóa thông tin sinh viên. <br>
                                <strong>2. Quản lý bài tập:</strong> Giao bài tập và xem danh sách nộp bài tập. <br>
                                <strong>3. Quiz:</strong> Tạo quiz và xem danh sách các sinh viên trả lời đúng. <br>
                            </p>
                        </div>
                    </div>
