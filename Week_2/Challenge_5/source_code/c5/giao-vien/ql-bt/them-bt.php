        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="ds-bt.php">Danh sách bài tập</a>
                        <a class="collapse-item active" href="them-bt.php">Thêm bài tập</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><strong>Thêm bài tập</strong></h1>
                    <p class="mb-4">Điền đầy đủ thông tin để tiến hành thêm bài tập mới.</a>.</p>
                    ...
                    if (array_key_exists("btn_insert", $_REQUEST)) {
                        ...
                        if ($ten_bt == "" | $do_kho == "" | $thoi_gian == "" | $_FILES['tep_dinh_kem']['size'] == 0) {
                            echo '<script language="javascript">';
                            echo 'alert("Chưa nhập đủ thông tin!")';
                            echo '</script>';
                        } else {
                            $up_file = save_file("tep_dinh_kem", "attachments/");
                            $file = strlen($up_file) > 0 ? $up_file : 'attachment';

                            insert_bai_tap($ten_bt, $do_kho, $thoi_gian, $mo_ta, $file);
                            echo '<script language="javascript">';
                            echo 'alert("Thêm bài tập thành công")';
                            echo '</script>';
                            unset($ten_bt, $do_kho, $thoi_gian, $mo_ta, $file);
                        }
                    }
                    ?>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ten_bt" placeholder="Nhập tên bài tập ...">
                        </div>

                        <div class="form-group">
                            <label for="">Độ khó</label>
                            <!-- <input type="text" class="form-control" name="do_kho" placeholder="Nhập độ khó (Dễ, Trung Bình, Khó) ..."> -->
                        ...
                        <div class="form-group">
                            <label for="">Thời gian (tuần)</label>
                            <input type="number" class="form-control" name="thoi_gian" placeholder="Nhập thời gian làm (tính theo tuần) ...">
                        </div>
                        ...
                        <a class="btn btn-secondary custom" href="ds-bt.php">Quay lại</a>
                    </form>
